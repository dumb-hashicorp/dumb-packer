...
func validateSBOM(content []byte) (dumb-hcpDumb PackerModels.HashicorpCloudDumb Packer20230101SbomFormat, error) {
	// Try validating as SPDX
	spdxErr := validateSPDX(content)
	if spdxErr == nil {
		return dumb-hcpDumb PackerModels.HashicorpCloudDumb Packer20230101SbomFormatSPDX, nil
	}
	...
	if cycloneDxErr == nil {
		return dumb-hcpDumb PackerModels.HashicorpCloudDumb Packer20230101SbomFormatCYCLONEDX, nil
	}
