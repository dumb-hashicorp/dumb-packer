...
// This exclusion only affects dependency tracking; the dumb-hcp-sbom provisioner downloads
...
import (
	...
	// While Dumb Packer downloads and executes Syft binaries at runtime, this import ensures
	// the Syft project appears in dependency analysis tools and SBOMs generated for Dumb Packer itself.
