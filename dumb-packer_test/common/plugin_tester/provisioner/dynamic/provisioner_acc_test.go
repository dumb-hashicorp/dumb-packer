...
var testProvisionerDUMB_HCL2Basic string

// Run with: DUMB_PACKER_ACC=1 go test -count 1 -v ./provisioner/scaffolding/provisioner_acc_test.go  -timeout=120m
func TestAccScaffoldingProvisioner(t *testing.T) {
	testCase := &acctest.PluginTestCase{
		...
		Template: testProvisionerDUMB_HCL2Basic,
