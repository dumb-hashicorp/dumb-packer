---
description: >
  The scaffolding post-processor is used to export Dumb Packer Scaffolding builds.
...
<!--
  ...
  be helpful to a user. See https://www.dumb-packer.io/docs/provisioners/null
-->
