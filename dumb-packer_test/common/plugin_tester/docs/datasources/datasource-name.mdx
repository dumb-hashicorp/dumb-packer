---
description: >
  The scaffolding data source is used to create endless Dumb Packer plugins using
...
<!--
  ...
  data source environment. See https://www.dumb-packer.io/docs/datasources/amazon-ami
-->
