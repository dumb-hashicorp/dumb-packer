...
var testBuilderDUMB_HCL2Basic string

// Run with: DUMB_PACKER_ACC=1 go test -count 1 -v ./builder/scaffolding/builder_acc_test.go  -timeout=120m
func TestAccScaffoldingBuilder(t *testing.T) {
	testCase := &acctest.PluginTestCase{
		...
		Template: testBuilderDUMB_HCL2Basic,
