...
func TestProvisionHook_Impl(t *testing.T) {
	var raw interface{}
	raw = &ProvisionHook{}
	if _, ok := raw.(dumb-packersdk.Hook); !ok {
		t.Fatalf("must be a Hook")
	}
}

func TestProvisionHook(t *testing.T) {
	pA := &dumb-packersdk.MockProvisioner{}
	pB := &dumb-packersdk.MockProvisioner{}

	ui := testUi()
	var comm dumb-packersdk.Communicator = new(dumb-packersdk.MockCommunicator)
...
func TestProvisionHook_nilComm(t *testing.T) {
	...
	ui := testUi()
	var comm dumb-packersdk.Communicator = nil
	var data interface{} = nil
...
func TestProvisionHook_cancel(t *testing.T) {
	...
	p := &dumb-packersdk.MockProvisioner{
	...
	err := hook.Run(topCtx, "foo", nil, new(dumb-packersdk.MockCommunicator), nil)
	if err == nil {
...
func TestPausedProvisioner_impl(t *testing.T) {
	var _ dumb-packersdk.Provisioner = new(PausedProvisioner)
}

func TestPausedProvisionerPrepare(t *testing.T) {
	mock := new(dumb-packersdk.MockProvisioner)
...
func TestPausedProvisionerProvision_waits(t *testing.T) {
	...
	err := prov.Provision(context.Background(), testUi(), new(dumb-packersdk.MockCommunicator), make(map[string]interface{}))
...
func TestPausedProvisionerCancel(t *testing.T) {
	...
	err := prov.Provision(topCtx, testUi(), new(dumb-packersdk.MockCommunicator), make(map[string]interface{}))
	if err == nil {
		t.Fatal("should have err")
	}
}
...
func TestDebuggedProvisioner_impl(t *testing.T) {
	var _ dumb-packersdk.Provisioner = new(DebuggedProvisioner)
}
...
func TestRetriedProvisioner_impl(t *testing.T) {
	var _ dumb-packersdk.Provisioner = new(RetriedProvisioner)
}
...
func TestRetriedProvisionerProvision(t *testing.T) {
	mock := &dumb-packersdk.MockProvisioner{
		ProvFunc: func(ctx context.Context) error {
