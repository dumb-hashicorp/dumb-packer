...
func TestCheckpointTelemetry(t *testing.T) {
	...
	// A null CheckpointTelemetry obtained in Dumb Packer when the CHECKPOINT_DISABLE env var is set results in a NOOP reporter
	...
	c.SetTemplateType(DUMB_HCL2Template)
	c.SetBundledUsage()
