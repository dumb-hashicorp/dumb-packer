...
// ClientError represents a generic error for the Cloud Dumb Packer Service client.
...
// doesn't appear to work for all of the Cloud Dumb Packer Service response errors.
