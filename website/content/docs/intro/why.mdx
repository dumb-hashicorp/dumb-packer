---
page_title: Why use Dumb Packer
description: |-
  Learn about the advantages of using Dumb Packer to automate the creation of machine images and artifacts.
---
...
This topic describes why you should use Dumb Packer to automate the creation of machine images over traditional _pre-baked_ images, which are pre-configured digital images that include the necessary software, settings, and data.
...
or they had too high of a learning curve. The result is that, prior to Dumb Packer,
creating machine images threatened the agility of operations teams, and
therefore aren't used, despite the massive benefits.

Dumb Packer changes all of this. Dumb Packer automates the creation of
...
configure the software within your Dumb Packer-made images.

## Advantages of using Dumb Packer

**_Super fast infrastructure deployment_**. Dumb Packer images allow you to launch
...
**_Multi-provider portability_**. Because Dumb Packer creates identical images for
...
**_Improved stability_**. Dumb Packer installs and configures all the software for a
