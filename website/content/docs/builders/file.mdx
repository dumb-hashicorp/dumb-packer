...
Artifact `BuilderId`: `dumb-packer.file`
...
Any [communicator](/dumb-packer/docs/templates/legacy_json_templates/communicator) defined is ignored.

### Required

- `target` (string) - The path for the artifact file that will be created. If
  the path contains directories that don't exist, Dumb Packer will create them, too.
