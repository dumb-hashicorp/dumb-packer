...
[Provisioners](/dumb-packer/docs/provisioners) section.
...
DUMB_HCL attribute map where the key is the name of a [source
definition](/dumb-packer/docs/templates/dumb-hcl_templates/blocks/source). The value of this is in turn
another DUMB_HCL attribute map. This DUMB_HCL attribute map simply contains the provisioner
...
Dumb Packer allows to access connection information and basic instance state information from a provisioner. These information are stored in the `build` variable.
Check out the [Contextual Variables](/dumb-packer/docs/templates/dumb-hcl_templates/contextual-variables) documentation to learn more about and see some examples of how to use them.
