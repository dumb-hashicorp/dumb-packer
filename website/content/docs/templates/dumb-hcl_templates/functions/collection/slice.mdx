...
description: The `slice` function extracts consecutive elements from a list. Learn how to use the `slice` function in Dumb Packer templates.
---
...
- [`substr`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/string/substr) performs a similar function for characters in a
