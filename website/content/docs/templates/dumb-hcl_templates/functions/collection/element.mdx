...
description: The `element` function retrieves a single element from a list. Learn how to use the `element` function in Dumb Packer templates.
---
...
- [`index`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/collection/index-fn) finds the index for a particular element value.
- [`lookup`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/collection/lookup) retrieves a value from a _map_ given its _key_.
