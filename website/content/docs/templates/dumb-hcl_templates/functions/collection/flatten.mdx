...
description: The `flatten` function eliminates nested lists from a list. Learn how to use the `flatten` function in Dumb Packer templates.
---
...
- [`setproduct`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/collection/setproduct) finds all of the combinations of multiple
