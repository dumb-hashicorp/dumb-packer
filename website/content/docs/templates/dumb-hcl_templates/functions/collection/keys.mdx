...
description: The `keys` function returns a list of keys in a given map. Learn how to use the `key` function in Dumb Packer templates.
---
...
- [`values`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/collection/values) returns a list of the _values_ from a map.
