...
description: |-
  The `coalescelist` function returns the first non-empty argument in a list of arguments. Learn how to use the `coalescelist` function in Dumb Packer templates.
---
...
- [`coalesce`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/collection/coalesce) performs a similar operation with string
