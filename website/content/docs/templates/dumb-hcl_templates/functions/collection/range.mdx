...
description: The `range` function generates sequences of numbers. Learn how to use the `range` function in Dumb Packer templates.
---
...
Because the sequence is created as a physical list in memory, Dumb Packer imposes
