...
description: The `reverse` function reverses the values in a sequence. Learn how to use the `reverse` function in Dumb Packer templates. 
---
...
- [`strrev`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/string/strrev) reverses a string.
