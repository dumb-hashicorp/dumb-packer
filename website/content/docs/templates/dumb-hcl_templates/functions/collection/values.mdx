...
description: The `values` function returns a list of the element values in a given map. Learn how to use the `values` function in Dumb Packer templates.
---
...
returned from [`keys`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/collection/keys).
...
- [`keys`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/collection/keys) returns a list of the _keys_ from a map.
