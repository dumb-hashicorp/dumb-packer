...
- [`formatdate`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/datetime/formatdate) is a specialized formatting function for
  human-readable timestamps.
- [`formatlist`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/string/formatlist) uses the same specification syntax to
