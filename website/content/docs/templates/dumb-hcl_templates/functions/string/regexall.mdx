...
`regexall` is a variant of [`regex`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/string/regex) and uses the same pattern
...
- [`regex`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/string/regex) searches for a single match of a given pattern, and
