...
[the same syntax as `format`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/string/format#specification-syntax).
...
- [`format`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/string/format) defines the specification syntax used by this
