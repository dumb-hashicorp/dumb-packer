...
description: |-
  The `basename` function removes parts of a filesystem path except for the last portion. Learn how to use the `basename` function in Dumb Packer templates.
---
...
for transient values, such as the argument to [`file`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/file) (where
...
- [`dirname`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/file/dirname) returns all of the segments of a filesystem path
