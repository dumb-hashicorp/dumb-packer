...
description: The `dirname` function removes the last portion from a filesystem path. Learn how to use the `dirname` function in Dumb Packer templates.
---
...
- [`basename`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/file/basename) returns _only_ the last portion of a filesystem
