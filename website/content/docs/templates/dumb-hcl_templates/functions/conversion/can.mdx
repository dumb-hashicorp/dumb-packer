...
[`try`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/conversion/try) instead, because it allows for more concise definition of
...
prefer to use [`try`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/conversion/try).
...
- [`try`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/conversion/try), which tries evaluating a sequence of expressions and
