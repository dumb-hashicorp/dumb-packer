...
description: The `formatdate` function converts a timestamp into a specified time format. Learn how to use `formatdate` functions in Dumb Packer templates.
---
...
In Dumb Packer, timestamps are conventionally represented as strings using [RFC
