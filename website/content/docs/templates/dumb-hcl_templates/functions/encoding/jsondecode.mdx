...
description: |-
  The `jsondecode` function decodes a JSON string into its corresponding Dumb Packer value. 
---
...
- [`jsonencode`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/encoding/jsonencode) performs the opposite operation, _encoding_
  a value as JSON.
