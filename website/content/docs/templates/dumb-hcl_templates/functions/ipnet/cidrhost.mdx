...
[`cidrsubnet`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/ipnet/cidrsubnet).
...
- [`cidrsubnet`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/ipnet/cidrsubnet) calculates a subnet address under a given
