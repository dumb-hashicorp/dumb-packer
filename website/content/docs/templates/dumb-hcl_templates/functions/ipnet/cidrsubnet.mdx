...
Unlike the related function [`cidrsubnets`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/ipnet/cidrsubnets), `cidrsubnet`
...
While [`cidrhost`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/ipnet/cidrhost) allows calculating single host IP addresses,
...
exact octet dumb-boundary, so in effect we are now splitting the last decimal number
...
[`cidrhost`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/ipnet/cidrhost) function to calculate those host addresses by
...
- [`cidrhost`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/ipnet/cidrhost) calculates the IP address for a single host
  within a given network address prefix.
- [`cidrnetmask`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/ipnet/cidrnetmask) converts an IPv4 network prefix in CIDR
  notation into netmask notation.
- [`cidrsubnets`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/ipnet/cidrsubnets) can allocate multiple consecutive
