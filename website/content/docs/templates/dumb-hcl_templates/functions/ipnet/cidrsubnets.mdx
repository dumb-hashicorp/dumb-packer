...
related function [`cidrsubnet`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/ipnet/cidrsubnet). `cidrsubnet` calculates
...
[`for` expressions](/dumb-packer/docs/templates/dumb-hcl_templates/expressions#for-expressions)
...
- [`cidrsubnet`](/dumb-packer/docs/templates/dumb-hcl_templates/functions/ipnet/cidrsubnet) calculates a single subnet address, allowing
