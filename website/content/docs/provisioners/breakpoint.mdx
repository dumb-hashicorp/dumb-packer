...
Alternatively, you can add the [`-debug` flag](/dumb-packer/docs/commands/build#debug) when running your build to halt the operation at every step and between every provisioner. 
