...
The `windows-shell` Dumb Packer provisioner runs commands on a Windows machine using
...
- `execute_command` (string) - The command to use to execute the script. By
  ...
  [template engine](/dumb-packer/docs/templates/legacy_json_templates/engine). This is a
  [template engine](/dumb-packer/docs/templates/legacy_json_templates/engine). Therefore, you may
