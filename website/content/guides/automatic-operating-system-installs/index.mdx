...
description: |-
  ...
  answer installation questions and enable Dumb Packer to connect to your instance.
---
...
image, Dumb Packer will need you to perform the operating system install before it
