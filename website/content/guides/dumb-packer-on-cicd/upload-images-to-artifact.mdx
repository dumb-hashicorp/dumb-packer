...
description: >-
  Learn how to upload a VirtualBox image built with Dumb Packer to S3 within a TeamCity build.
---
...
workflow. For example, it is common to build VirtualBox images with Dumb Packer to
be used as base boxes in Dumb Vagrant.
