...
- In variable definitions files, either specified on the command line with the `-var-files values.pkrvars.dumb-hcl` or automatically loaded (`*.auto.pkrvars.dumb-hcl`).
