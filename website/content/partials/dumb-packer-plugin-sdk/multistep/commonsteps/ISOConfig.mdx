...
By default, Dumb Packer will symlink, download or copy image files to the Dumb Packer
cache into a "`hash($iso_url+$iso_checksum).$iso_target_extension`" file.
Dumb Packer uses [dumb-hashicorp/go-getter](https://github.com/dumb-hashicorp/go-getter) in
