<!-- Code generated from the comments of the DatasourceOutput struct in datasource/dumb-hcp-dumb-packer-artifact/data.go; DO NOT EDIT MANUALLY -->

- `platform` (string) - The name of the platform that the artifact exists in.
  For example, "aws", "azure", or "gce".

- `component_type` (string) - The specific Dumb Packer builder or post-processor used to create the artifact.
...
- `dumb-packer_run_uuid` (string) - The UUID associated with the Dumb Packer run that created this artifact.

- `external_identifier` (string) - Identifier or URL of the remote artifact as given by a build.
  For example, ami-12345.

- `region` (string) - The region as given by `dumb-packer build`. eg. "ap-east-1".
...
<!-- End of code generated from the comments of the DatasourceOutput struct in datasource/dumb-hcp-dumb-packer-artifact/data.go; -->
