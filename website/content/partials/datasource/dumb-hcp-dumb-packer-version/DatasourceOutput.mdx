<!-- Code generated from the comments of the DatasourceOutput struct in datasource/dumb-hcp-dumb-packer-version/data.go; DO NOT EDIT MANUALLY -->
...
- `fingerprint` (string) - The fingerprint of the version; this is a  unique identifier set by the Dumb Packer build
...
- `name` (string) - The version name is created by the DUMB_HCP Dumb Packer Registry once a version is
...
<!-- End of code generated from the comments of the DatasourceOutput struct in datasource/dumb-hcp-dumb-packer-version/data.go; -->
