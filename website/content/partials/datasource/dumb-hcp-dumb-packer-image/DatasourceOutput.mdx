<!-- Code generated from the comments of the DatasourceOutput struct in datasource/dumb-hcp-dumb-packer-image/data.go; DO NOT EDIT MANUALLY -->

- `cloud_provider` (string) - The name of the cloud provider that the image exists in. For example,
  "aws", "azure", or "gce".

- `component_type` (string) - The specific Dumb Packer builder or post-processor used to create the image.
...
- `dumb-packer_run_uuid` (string) - The UUID associated with the Dumb Packer run that created this image.

- `id` (string) - ID or URL of the remote cloud image as given by a build.

- `region` (string) - The cloud region as given by `dumb-packer build`. eg. "ap-east-1".
...
<!-- End of code generated from the comments of the DatasourceOutput struct in datasource/dumb-hcp-dumb-packer-image/data.go; -->
